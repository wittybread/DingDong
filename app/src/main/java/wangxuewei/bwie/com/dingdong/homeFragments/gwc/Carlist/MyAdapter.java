package wangxuewei.bwie.com.dingdong.homeFragments.gwc.Carlist;
...
import wangxuewei.bwie.com.dingdong.homeFragments.gwc.GwcPresenter;
import wangxuewei.bwie.com.dingdong.homeFragments.gwc.GwcViewAPI;
...
public class MyAdapter extends BaseExpandableListAdapter {
    ...
    public MyAdapter(Context context, List<CartBean.DataBean> groupList, List<List<CartBean.DataBean.ListBean>> childList, GwcViewAPI gwcViewAPI, int uid) {
...
//        holder.tv_number.setText(dataBean.getTitle());
    ...
    public View getChildView(final int i, final int i1, boolean b, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            holder.imgIcon = (ImageView) view.findViewById(R.id.child_img);
            holder.tv_price = (TextView) view.findViewById(R.id.child_price);
            holder.tv_del = (TextView) view.findViewById(R.id.tv_remove);
            holder.iv_add = (ImageView) view.findViewById(R.id.tv_add);
            holder.iv_del = (ImageView) view.findViewById(R.id.tv_del);
        ...
        final int pid = childList.get(i).get(i1).getPid();
        //删除
                ...
                if (childList != null && childList.size() != 0) {
                    ...
                    builder.setPositiveButton("确认", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Log.d("WXW", "adapter" + uid + "aaa" + pid);
                            Map<String, String> map = new HashMap<>();
                            map.put("uid", uid + "");
                            map.put("pid", pid + "");
                            GwcPresenter gwcPresenter = new GwcPresenter(gwcViewAPI, context);

                            gwcPresenter.DelCar("http://120.27.23.105/product/deleteCart", map);
                            ...
                            EventBus.getDefault().post(groupList.size()+"");
